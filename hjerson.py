...
while (hline and rline):
    ...
    if sent:
        ...
        sumCount = sentInflHper + sentMissCount + sentHypLexCount + sentExtCount + sentHypReordCount
        ...
        write_error_rates(errtxt, str(nSent)+"::rINFer: ", sentInflRperCount, iRper)
        write_error_rates(errtxt, str(nSent)+"::hINFer: ", sentInflHperCount, iHper)
        write_error_rates(errtxt, str(nSent)+"::rRer:   ", sentRefReordCount, rRer)
        write_error_rates(errtxt, str(nSent)+"::hRer:   ", sentHypReordCount, hRer)
        ...
        write_error_rates(errtxt, str(nSent)+"::rLEXer: ", sentRefLexCount, rLexErr)
        write_error_rates(errtxt, str(nSent)+"::hLEXer: ", sentHypLexCount, hLexErr)

        errtxt.write("\n")

        write_error_rates(errtxt, str(nSent)+"::brINFer: ", sentBlockInflRperCount, biRper)
        write_error_rates(errtxt, str(nSent)+"::bhINFer: ", sentBlockInflHperCount, biHper)
        write_error_rates(errtxt, str(nSent)+"::brRer:   ", sentRefBlockReordCount, rbRer)
        write_error_rates(errtxt, str(nSent)+"::bhRer:   ", sentHypBlockReordCount, hbRer)
        ...
        write_error_rates(errtxt, str(nSent)+"::brLEXer: ", sentRefBlockLexCount, rbLexErr)
        write_error_rates(errtxt, str(nSent)+"::bhLEXer: ", sentHypBlockLexCount, hbLexErr)
